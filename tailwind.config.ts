  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'h1': ['46px', { lineHeight: '1.2', letterSpacing: '-0.02em', fontWeight: '700' }],
        'h2': ['36px', { lineHeight: '1.3', letterSpacing: '-0.015em', fontWeight: '600' }],
        'h3': ['28px', { lineHeight: '1.4', fontWeight: '600' }],
        'body': ['19px', { lineHeight: '1.6', fontWeight: '400' }],
        'caption': ['17px', { lineHeight: '1.5', fontWeight: '400' }],
        'kpi': ['52px', { lineHeight: '1', letterSpacing: '-0.03em', fontWeight: '800' }],
        'kpi-sm': ['19px', { lineHeight: '1.4', fontWeight: '600' }],
      },
      colors: {
