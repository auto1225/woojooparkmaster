...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'display': ['56px', { lineHeight: '1.1', letterSpacing: '-0.025em', fontWeight: '700' }],
        'h1': ['44px', { lineHeight: '1.2', letterSpacing: '-0.02em', fontWeight: '700' }],
        'h2': ['34px', { lineHeight: '1.3', letterSpacing: '-0.015em', fontWeight: '600' }],
        'h3': ['26px', { lineHeight: '1.4', fontWeight: '600' }],
        'body': ['18px', { lineHeight: '1.6', fontWeight: '400' }],
        'caption': ['16px', { lineHeight: '1.5', fontWeight: '400' }],
        'kpi': ['48px', { lineHeight: '1', letterSpacing: '-0.03em', fontWeight: '800' }],
        'kpi-sm': ['18px', { lineHeight: '1.4', fontWeight: '600' }],
      },
      colors: {
