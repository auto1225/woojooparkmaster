...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'display': ['40px', { lineHeight: '1.1', letterSpacing: '-0.025em', fontWeight: '700' }],
        ...
        'kpi': ['36px', { lineHeight: '1', letterSpacing: '-0.03em', fontWeight: '800' }],
        'kpi-sm': ['15px', { lineHeight: '1.4', fontWeight: '600' }],
      },
      colors: {
