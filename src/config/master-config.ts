  ...
  tabs: [{
    ...
    queryFn: async () => {
      ...
      return (data || []).map((s: any, i: number) => ({
        ...
        address_jibun: s.parking_lots?.address_jibun, address_road: s.parking_lots?.address_road,
        survey_date: s.survey_date, surveyor_name: s.surveyor_name, status: s.status,
        lot_type: s.parking_lots?.lot_type, operator_type: s.parking_lots?.operator_type,
