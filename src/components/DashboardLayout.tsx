...
const BREADCRUMB_MAP: Record<string, { label: string; parent?: string }> = {
  ...
  "/ops/report": { label: "운영 보고서", parent: "/ops" },
  "/facility": { label: "시설관리" },
  ...
  "/reports/ranking": { label: "주차장 성과 순위", parent: "/reports" },
  "/reports/executive": { label: "간부용 현황판", parent: "/reports" },
  "/reports/print-quarterly": { label: "분기 보고서", parent: "/reports" },
