    ...
    try {
      ...
      await Promise.all([
        supabase.from("survey_basic_info").insert({
          ...
          address: lotDetail?.address_jibun || lotDetail?.address_road,
          lot_type: lotDetail?.lot_type,
          operator_type: lotDetail?.operator_type,
          surface_type: lotDetail?.surface_type,
          total_spaces: lotDetail?.total_spaces || 0,
          disabled_spaces: lotDetail?.disabled_spaces || 0,
          ev_spaces: lotDetail?.ev_spaces || 0,
          compact_spaces: lotDetail?.compact_spaces || 0,
          pregnant_spaces: lotDetail?.pregnant_spaces || 0,
          entry_count: lotDetail?.entry_count || null,
          exit_count: lotDetail?.exit_count || null,
