...
const PASSWORD_CHECKS = [
  { label: "8자 이상", test: (password: string) => password.length >= 8 },
  { label: "대문자 포함", test: (password: string) => /[A-Z]/.test(password) },
  { label: "숫자 포함", test: (password: string) => /[0-9]/.test(password) },
  {
    label: "특수문자 포함",
  ...
  const strengthColor =
    passedChecks <= 1
      ...
      : passedChecks <= 3
        ...
        : "bg-success";
  const strengthLabel =
    passedChecks <= 1 ? "약함" : passedChecks <= 3 ? "보통" : "강함";
      ...
      <div className="max-w-2xl mx-auto space-y-6">
            ...
            <RadioGroup value={theme} onValueChange={(value) => setTheme(value as Theme)}>
              ...
              <div className="flex items-center gap-3">
                ...
                <Label
                  ...
                  className="flex items-center gap-2 cursor-pointer"
                >
                  <Monitor className="h-4 w-4" />시스템 자동
                </Label>
              </div>
            </RadioGroup>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {NOTIF_SETTINGS_KEYS.map((setting) => (
              <div
                key={setting.key}
              ...
              >
                ...
                <Switch
                  checked={notifSettings[setting.key] !== false}
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={notifSettings.urgent_only === true}
                onCheckedChange={() => toggleNotif("urgent_only")}
              />
            </div>
          </CardContent>
        </Card>
