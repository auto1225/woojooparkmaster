...
const ids = {
  ...
  teamWork: "bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb",
  teamDuty: "cccccccc-cccc-4ccc-8ccc-cccccccccccc",
  businessCard: "dddddddd-dddd-4ddd-8ddd-dddddddddddd",
};
...
const fixtures = {
  ...
  code_master: [
    {
      ...
      code: "DOC-E2E",
      name_ko: "E2E 공영주차장 점검계획",
      name_en: "제주시청-차량관리과운영팀-2026-E2E",
      is_active: true,
      extra: {
        document_number: "제주시청-차량관리과운영팀-2026-E2E",
        normalized_number: "제주시청차량관리과운영팀2026E2E",
        title: "E2E 공영주차장 점검계획",
        direction: "internal",
        document_type: "업무계획",
        document_date: today,
  ...
  business_card_records: [
    {
      id: ids.businessCard,
      card_number: "BC-E2E-001",
      name: "E2E 시설담당자",
      company: "E2E 시설협력사",
      department: "시설사업팀",
      position: "팀장",
      ...
      phone: "064-728-3900",
      fax: "064-728-3901",
      email: "facility.e2e@example.test",
      ...
      image_path: null,
      image_name: null,
      business_category: "facility",
      lot_types: ["offstreet", "multilevel", "onstreet"],
      preferred_channel: "mobile",
      emergency_contact: true,
      collection_source: "business_card",
      business_purpose: "공영주차장 시설 유지보수 연락",
      last_verified_at: today,
      retention_review_date: "2029-08-03",
      ocr_completeness: 100,
      retain_ocr_text: false,
      owning_team: "제주시청 차량관리과 운영팀",
      row_version: 1,
      archived_at: null,
      archive_reason: null,
      created_at: isoNow,
  ...
  business_card_links: [
    {
      id: "business-card-link-e2e",
      card_id: ids.businessCard,
      module: "FACILITY_EQUIPMENT",
      record_id: ids.equipment,
      record_label: "EQ-E2E-001 E2E 차단기",
      record_path: `/facility/equipment?equipment=${ids.equipment}`,
      company_name: "E2E 시설협력사",
      relation_type: "company_contact",
      lot_id: ids.lot,
    },
  ],
  attachments: [],
  ...
  survey_usage: [
    {
      id: "su-1",
      survey_id: ids.survey,
      peak_occupancy_rate: 82,
      average_turnover: 3.4,
    },
  ],
  survey_sensor_plan: [
    {
  ...
  maintenance_logs: [
    {
      ...
      lot_id: lot.id,
      parking_lots: nestedLot,
      equipment: { name: "E2E 차단기", equipment_type: "barrier" },
      log_number: "ML-E2E-001",
      title: "차단기 점검",
      status: "assigned",
      priority: "high",
      reported_at: isoNow,
  ...
  bid_projects: [
    {
      ...
      lot_id: lot.id,
      parking_lots: nestedLot,
      bid_number: "BID-E2E-001",
      title: "차단기 교체 입찰",
      bid_type: "construction",
      estimated_amount: 12000000,
      contract_amount: 11500000,
      successful_bidder: "E2E 시공",
      bid_deadline: today,
      status: "open",
      description: "[DEMO]",
    },
  ...
  service_projects: [
    {
      ...
      lot_id: lot.id,
      parking_lots: nestedLot,
      supervisor: sampleProfile,
      inspector: sampleProfile,
      project_number: "SV-E2E-001",
      title: "E2E 용역사업",
      service_type: "maintenance",
      contractor_name: "E2E 용역사",
      start_date: today,
      end_date: "2026-12-31",
      progress_pct: 45,
      status: "in_progress",
  ...
  construction_projects: [
    {
      ...
      site_id: "site-1",
      site: { name: "E2E 후보지" },
      parking_lot: nestedLot,
      project_number: "CP-E2E",
      title: "E2E 신설공사",
      status: "construction",
      progress_pct: 35,
      start_date: today,
  ...
  gateway_devices: [
    {
      ...
      lot_id: lot.id,
      parking_lots: nestedLot,
      device_id: "GW-E2E-001",
      device_name: "E2E 게이트웨이",
      status: "online",
      last_seen_at: isoNow,
    },
  ],
  sensor_devices: [
    {
      ...
      lot_id: lot.id,
      parking_lots: nestedLot,
      gateway_devices: { device_id: "GW-E2E-001" },
      device_id: "S-E2E-001",
      device_name: "A-01 센서",
  ...
  sensor_incidents: [
    {
      id: "incident-1",
      lot_id: lot.id,
      parking_lots: { name: lot.name },
      sensor_devices: { device_id: "S-E2E-001", device_name: "A-01 센서" },
      maintenance_logs: { log_number: "ML-E2E-001", status: "assigned" },
      status: "open",
      priority: "high",
      title: "센서 미응답",
      detected_at: isoNow,
  ...
  sensor_readings: [
    { id: "reading-1", sensor_id: "S-E2E-001", value: 1, measured_at: isoNow },
  ],
  display_boards: [
    {
      id: "display-1",
  ...
  report_generated: [
    {
      id: ids.report,
      report_number: "RPT-GEN-E2E",
      template_id: "tmpl-1",
      template: { name: "E2E 종합 보고서", template_code: "RPT-E2E" },
      title: "E2E 생성 보고서",
      status: "completed",
      output_paths: ["/demo/report.pdf"],
      period_start: today,
      period_end: today,
      created_at: isoNow,
    },
  ...
  report_schedules: [
    {
      id: "rs-1",
      template_id: "tmpl-1",
      template: { name: "E2E 종합 보고서" },
      schedule_name: "월간 E2E",
      cron_expr: "0 9 1 * *",
      next_run: isoNow,
      is_active: true,
    },
  ...
  team_work_records: [
    {
      id: ids.teamWork,
      record_number: "WO-E2E-001",
      record_type: "work_order",
      team: "facilities",
      title: "E2E 노외주차장 차단기 현장 조치",
      category: "시설보수",
      lot_id: lot.id,
      parking_lot_name: lot.name,
      lot_type_snapshot: lot.lot_type,
      parking_lots: nestedLot,
      owner_id: ids.user,
      ...
      document_number: "제주시청-차량관리과운영팀-2026-E2E",
      reviewer_name: "검토 주무관",
      next_action: "현장 사진 확인",
      hold_reason: null,
      source_module: "FACILITY_MAINTENANCE",
      source_record_id: ids.maintenance,
      source_path: `/facility/maintenance?maintenance=${ids.maintenance}`,
      client_mutation_id: null,
      row_version: 1,
      archived_at: null,
      archive_reason: null,
      payload: { evidence: "현장 점검 사진" },
      created_at: isoNow,
      updated_at: isoNow,
    },
  ],
  team_duty_records: [
    {
      id: ids.teamDuty,
      duty_code: "DUTY-E2E-001",
      team: "operations",
      area: "E2E 노상주차장 현장 대응",
      role_name: "운영팀 주무관",
      phone: "064-728-3822",
      duties: ["노상 주차면 훼손 확인", "민원과 시설보수 후속 업무 연계"],
      record_type: "compliance",
      category: "노상안전점검",
      destination: "/facility/safety",
      destination_label: "안전점검",
      primary_assignee_id: ids.user,
      primary_assignee: sampleProfile,
      deputy_assignee_id: null,
      deputy_assignee: null,
      ...
      handover_due_date: null,
      handover_note: null,
      change_reason: "E2E 검증",
      row_version: 1,
      archived_at: null,
      archive_reason: null,
      created_at: isoNow,
  ...
  pii_access_logs: [
    {
      ...
      field_name: "complainant_phone",
      accessed_at: isoNow,
    },
  ],
  active_sessions: [
    { id: "sess-1", user_id: ids.user, is_active: true, last_activity: isoNow },
  ],
  ip_whitelist: [
    {
      id: "ip-1",
...
function objectRequested(request) {
  return (request.headers().accept || "").includes(
...
async function installMocks(page) {
  ...
  await page.route("**/functions/v1/**", (route) =>
    fulfillJson(route, {
      success: true,
      data: {},
      message: "E2E mock function response",
    }),
  );
  await page.route("**/storage/v1/**", (route) =>
    fulfillJson(route, {
      signedURL: "/demo/mock-file",
      path: "/demo/mock-file",
    }),
  );
  await page.route("**/rest/v1/rpc/**", (route) =>
    fulfillJson(route, [{ success: true, id: "rpc-e2e", status: "ok" }]),
  );
  await page.route("**/rest/v1/**", async (route, request) => {
    const url = new URL(request.url());
    const table = decodeURIComponent(
      url.pathname.split("/rest/v1/")[1] || "",
    ).split("/")[0];
    ...
    if (method === "POST" || method === "PATCH" || method === "PUT") {
      ...
      const body = objectRequested(request)
        ? { ...rows[0], ...payload }
        : [{ ...rows[0], ...(Array.isArray(payload) ? payload[0] : payload) }];
...
const routes = [
  ...
  "/facility/safety",
  "/facility/markings",
  `/facility/layout/${ids.lot}`,
  "/facility/analysis",
  "/revenue",
  "/revenue/daily",
  "/revenue/reconcile",
  "/revenue/analysis",
  "/revenue/print-monthly",
  "/budget",
  "/budget/plans",
  "/budget/plans/bp-1",
  "/budget/executions",
  ...
  `/procurement/projects/${ids.project}`,
  "/procurement/contracts",
  "/procurement/documents",
  "/service",
  "/service/projects",
  "/service/projects/new",
  `/service/projects/${ids.project}`,
  "/service/inspections",
  "/service/payments",
  "/service/issues",
  "/complaints",
  "/complaints/new",
  "/complaints/stats",
  `/complaints/${ids.complaint}`,
  "/planning",
  "/planning/sites",
  "/planning/projects",
  "/planning/projects/const-1",
  "/planning/documents",
  "/planning/permits",
  "/realtime",
  "/realtime/sensors",
...
page.on("console", (msg) => {
  if (["error", "warning"].includes(msg.type()))
    globalLogs.push({ type: msg.type(), text: msg.text(), url: page.url() });
});
page.on("pageerror", (error) =>
  globalLogs.push({ type: "pageerror", text: error.message, url: page.url() }),
);
...
for (const route of selectedRoutes) {
  ...
  const logs = globalLogs
    ...
    .filter((log) => !/Not using HTTPS/.test(log.text));
  if (
    status === "ok" &&
    logs.some((log) => log.type === "pageerror" || /error/i.test(log.text))
  )
...
const mobileDocumentButton = page.getByRole("button", {
  name: "제주시청-차량관리과운영팀-2026-E2E",
});
const mobileListCardVisible = await mobileDocumentButton
  .isVisible()
  .catch(() => false);
const desktopTableHidden = !(await page
  .locator("main table")
  .isVisible()
  .catch(() => false));
await mobileDocumentButton.click();
await page.waitForURL((url) => url.pathname === `/documents/${ids.document}`, {
  timeout: 10000,
});
await page
  .getByRole("heading", { name: "제주시청-차량관리과운영팀-2026-E2E" })
  .waitFor({ state: "visible", timeout: 10000 });
...
const mobileChecks = {
  listCardVisible: mobileListCardVisible,
  desktopTableHidden,
  listFitsViewport:
    mobileListMetrics.documentWidth <= mobileListMetrics.viewport,
  detailFitsViewport:
    mobileDetailMetrics.documentWidth <= mobileDetailMetrics.viewport,
  reverseLinkActionVisible: await page
    .getByRole("button", { name: "업무 연결" })
    .isVisible()
    .catch(() => false),
};

await page.goto(`${baseUrl}/team-work`, {
  waitUntil: "networkidle",
  timeout: 30000,
});
const mobileTeamMetrics = await page.evaluate(() => ({
  viewport: window.innerWidth,
  documentWidth: document.documentElement.scrollWidth,
}));
const mobileTeamCard = page
  .locator("main article")
  .filter({ hasText: "WO-E2E-001" });
mobileChecks.teamWorkCardVisible = await mobileTeamCard
  .isVisible()
  .catch(() => false);
mobileChecks.teamWorkTableHidden = !(await page
  .locator("main table")
  .isVisible()
  .catch(() => false));
mobileChecks.teamWorkFitsViewport =
  mobileTeamMetrics.documentWidth <= mobileTeamMetrics.viewport;
mobileChecks.teamWorkDetailActionVisible = await mobileTeamCard
  .getByRole("button", { name: "상세" })
  .isVisible()
  .catch(() => false);

await page.goto(`${baseUrl}/team-work/duties`, {
  waitUntil: "networkidle",
  timeout: 30000,
});
const mobileDutyMetrics = await page.evaluate(() => ({
  viewport: window.innerWidth,
  documentWidth: document.documentElement.scrollWidth,
}));
const mobileDutyCard = page
  .locator("main article")
  .filter({ hasText: "E2E 노상주차장 현장 대응" });
mobileChecks.teamDutyCardVisible = await mobileDutyCard
  .isVisible()
  .catch(() => false);
mobileChecks.teamDutyTableHidden = !(await page
  .locator("main table")
  .isVisible()
  .catch(() => false));
mobileChecks.teamDutyFitsViewport =
  mobileDutyMetrics.documentWidth <= mobileDutyMetrics.viewport;
mobileChecks.teamDutyTasksCollapsed = !(await mobileDutyCard
  .getByText("노면표시 훼손 확인", { exact: true })
  .isVisible()
  .catch(() => false));
mobileChecks.teamDutyFollowUpVisible = await mobileDutyCard
  .getByRole("link", { name: "업무 등록" })
  .isVisible()
  .catch(() => false);
...
const mobileBusinessCardMetrics = await page.evaluate(() => ({
  viewport: window.innerWidth,
  documentWidth: document.documentElement.scrollWidth,
}));
const mobileBusinessCard = page
  .locator("main article")
  .filter({ hasText: "E2E 시설담당자" });
mobileChecks.businessCardVisible = await mobileBusinessCard
  .isVisible()
  .catch(() => false);
mobileChecks.businessCardTableHidden = !(await page
  .locator("main table")
  .isVisible()
  .catch(() => false));
mobileChecks.businessCardFitsViewport =
  mobileBusinessCardMetrics.documentWidth <= mobileBusinessCardMetrics.viewport;
mobileChecks.businessCardPhoneVisible = await mobileBusinessCard
  .getByRole("link", { name: "전화" })
  .isVisible()
  .catch(() => false);
mobileChecks.businessCardMailVisible = await mobileBusinessCard
  .getByRole("link", { name: "메일" })
  .isVisible()
  .catch(() => false);
...
const mobileDashboardMetrics = await page.evaluate(() => ({
  viewport: window.innerWidth,
  documentWidth: document.documentElement.scrollWidth,
}));
const mobileSnapshot = page.getByRole("region", { name: "운영 업무 점검" });
mobileChecks.dashboardSnapshotVisible = await mobileSnapshot
  .isVisible()
  .catch(() => false);
mobileChecks.dashboardScopeControlsVisible = await mobileSnapshot
  .getByRole("button", { name: "노외", exact: true })
  .isVisible()
  .catch(() => false);
mobileChecks.dashboardComplaintDrilldownVisible = await mobileSnapshot
  .getByRole("button", { name: /처리 중 민원/ })
  .isVisible()
  .catch(() => false);
...
fs.writeFileSync(
  path.join(outDir, "all-menu-smoke-results.json"),
  JSON.stringify(summary, null, 2),
  "utf8",
);
fs.writeFileSync(
  path.join(outDir, "all-menu-smoke-summary.txt"),
  [
    ...
    ...summary.failures.map(
      (f) =>
        `${f.status}\t${f.route}\t${f.title}\t${f.logs.map((l) => l.text).join(" | ") || f.bodyText.slice(0, 160)}`,
    ),
  ].join("\n"),
  "utf8",
);
  ...
  JSON.stringify(
    {
      ...
      ok: summary.ok,
      failures: summary.failures.length,
      resultFile: path.join(outDir, "all-menu-smoke-results.json"),
    },
    null,
    2,
  ),
